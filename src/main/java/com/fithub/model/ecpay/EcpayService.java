...
public class EcpayService {
	...
	private String ngrokCode = "5102-1-172-213-25";
	private String returnURL = "https://" + ngrokCode + ".ngrok-free.app/";
	private String localhostPort = "5173";

	// Overloading of ecpayCheckout() for classroom rent order
	public String ecpayCheckout(EcpayDetailDTO ecpayDetailDTO) {
		...
		obj.setReturnURL(returnURL + "fithub/ecpay/callback");
		// 是否需要額外的付款資訊 Y|N
		obj.setNeedExtraPaidInfo("N");
		// 消費者點選此按鈕後，會將頁面導回到此設定的網址
		obj.setClientBackURL("http://localhost:" + localhostPort + "/");
	...
	// Overloading of ecpayCheckout() for course order
	public String ecpayCheckout(EcpayOrderDTO ecpayOrderDTO) {
		...
		// 交易描述
		obj.setTradeDesc("健身房課程訂單");
		// 交易結果回傳網址，只接受 https 開頭的網站，可以使用 ngrok
		obj.setReturnURL(returnURL + "fithub/ecpay/OrderCallback");
		// 是否需要額外的付款資訊 Y|N
		obj.setNeedExtraPaidInfo("N");
		// 消費者點選此按鈕後，會將頁面導回到此設定的網址
		obj.setClientBackURL("http://localhost:" + localhostPort + "/");
